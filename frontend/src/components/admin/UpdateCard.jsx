...
const UpdateCard = ({ id, bookname, authorname, rating, price, bookImage, type }) => {
    ...
    return (
        <div className={'flex flex-col gap-4'}>
            <div className={'flex bg-[#64748a] p-2 rounded-xl gap-4'}>
                ...
                <div className={'flex flex-col justify-between flex-1'}>
                    ...
                    <div className={'flex justify-end'}>
                        <button
                            onClick={handleClick}
                            className={'w-min flex items-center gap-2 text-white p-2 rounded-md bg-yellow-400 hover:bg-yellow-500 transition-all duration-300'}
                        >
                            Update <AiFillEdit />
                        </button>
                    </div>
            ...
            {
                open && (
                    <div className={'bg-[#64748a] rounded-lg'}>
                        ...
                        <h1 className={'font-medium text-center text-white'}>Edit Info For {bookname}!</h1>
                        <form className={'w-full text-white p-4 flex flex-col items-center gap-2'}>
                            <input
                                name="bookname"
                                value={updatedValues.bookname}
                                onChange={handleChange}
                                className={'w-full p-2 rounded-lg bg-black/10 focus:outline-none'}
